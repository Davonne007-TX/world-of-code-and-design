export default function SuperHero() {
  return (
    <section className="flex flex-col gap-8 justify-center items-center mt-12 px-6">
      <div className="max-w-xl lg:max-w-2xl text-center">
        <button className="bg-neutral-200 font-semibold text-pink-500 rounded-full text-lg tracking-widest px-6 mb-4 p-2">
          AI Powered Robot
        </button>
        ...
        <p className="mt-8 text-lg md:text-2xl text-gray-200/90 max-w-xl mx-auto">
        ...
        <button className=" mt-4 bg-gradient-to-b from-black via-[#1a1a1a] to-black font-orb text-xl cursor-pointer w-80 p-2 rounded">
          Learn More →
        </button>
      </div>
    </section>
