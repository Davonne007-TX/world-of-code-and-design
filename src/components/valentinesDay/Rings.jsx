  ...
  return (
    <section className="flex justify-center items-center">
      <div className="relative max-w-6xl">
        <Image image="./images/rings.jpg" className="w-full rounded-3xl" />

        <section className="absolute top-0 left-0 w-full font-thin mt-10 md:mt-40 flex flex-col justify-center items-center text-black px-4">
