export default function Hero() {
  const aboutSkateCompetition = [
    `2025 brings our Annual National Skating Skate Off. Skaters from across
  ...
  return (
    <section className="flex flex-col justify-center items-center text-white bg-black/50 p-8 rounded lg:mt-40">
