  ...
  return (
    <section className="flex flex-col justify-center items-center my-20">
      ...
      <div className="relative">
        <p className="absolute top-160 md:top-60 left-40 md:left-20 text-candy text-3xl md:text-5xl font-bold">
          I think its time for a wax.
        </p>

        <button className="absolute mt-4 top-170 mx-auto left-50 md:left-20 cursor-pointer transition-all duration-300 hover:scale-105 md:top-80 text-2xl bg-candy text-white p-2 rounded-full">
