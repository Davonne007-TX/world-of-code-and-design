  ...
  return (
    <section className="flex justify-center items-center text-center mt-80 md:mt-60">
      <section className="max-w-3xl bg-green-600  text-white p-2 rounded-xl mb-8">
        <h2 className="font-audio text-2xl md:text-4xl">
          Chase After Your Goal ..!
        </h2>
        <p className="font-audio text-2xl md:text-3xl mt-4">{help}</p>
        <p className="font-bold text-2xl md:text-3xl mt-4">{excuses}</p>
        <Button
          btnTxt={"Pledge Today"}
          className={
